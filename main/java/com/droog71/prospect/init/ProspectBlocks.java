...
public class ProspectBlocks 
{
	...
	{		
		...
		lv_conduit = new Conduit("lv_conduit",Material.IRON,1000,5000).setHardness(1.0f).setCreativeTab(Prospect.tabProspect);	
		mv_conduit = new Conduit("mv_conduit",Material.IRON,4000,20000).setHardness(1.0f).setCreativeTab(Prospect.tabProspect);
		hv_conduit = new Conduit("hv_conduit",Material.IRON,9000,45000).setHardness(1.0f).setCreativeTab(Prospect.tabProspect);
		ev_conduit = new Conduit("ev_conduit",Material.IRON,16000,80000).setHardness(1.0f).setCreativeTab(Prospect.tabProspect);
		iv_conduit = new Conduit("iv_conduit",Material.IRON,25000,125000).setHardness(1.0f).setCreativeTab(Prospect.tabProspect);
	...
	public static void registerBlocks(RegistryEvent.Register<Block> event) 
	{
		...
		event.getRegistry().registerAll(lv_conduit);
		event.getRegistry().registerAll(mv_conduit);
		event.getRegistry().registerAll(hv_conduit);
		event.getRegistry().registerAll(ev_conduit);
		event.getRegistry().registerAll(iv_conduit);
	...
	public static void registerItemBlocks(RegistryEvent.Register<Item> event) 
	{
		...
		event.getRegistry().registerAll(new ItemBlock(lv_conduit).setRegistryName(lv_conduit.getRegistryName()));
		event.getRegistry().registerAll(new ItemBlock(mv_conduit).setRegistryName(mv_conduit.getRegistryName()));
		event.getRegistry().registerAll(new ItemBlock(hv_conduit).setRegistryName(hv_conduit.getRegistryName()));
		event.getRegistry().registerAll(new ItemBlock(ev_conduit).setRegistryName(ev_conduit.getRegistryName()));
		event.getRegistry().registerAll(new ItemBlock(iv_conduit).setRegistryName(iv_conduit.getRegistryName()));
	...
	public static void registerRenders(ModelRegistryEvent event) 
	{
		...
		registerRender(Item.getItemFromBlock(lv_conduit));
		registerRender(Item.getItemFromBlock(mv_conduit));
		registerRender(Item.getItemFromBlock(hv_conduit));
		registerRender(Item.getItemFromBlock(ev_conduit));
		registerRender(Item.getItemFromBlock(iv_conduit));
